package org.example.lookie.common.util;
...
import org.example.lookie.common.exception.SecurityCustomException;
import org.example.lookie.controller.user.dto.LoginResponse;
...
import static org.example.lookie.common.exception.SecurityErrorCode.INVALID_TOKEN;
import static org.example.lookie.common.exception.SecurityErrorCode.TOKEN_EXPIRED;
...
public class JwtUtil {
    ...
    public Authentication resolveToken(String token) {
        ...
        UserInfoDTO userInfo = userService.loadUserInfoByEmail(getEmail(token));
